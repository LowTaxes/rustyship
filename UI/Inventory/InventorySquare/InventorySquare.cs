...
public partial class InventorySquare : Control
{
	...
	public override void _Ready()
	{
		...
		//Debug.Print(area2d.Scale);
		float scale = Constants.inventory_square_size / area2d.GetChild<CollisionShape2D>(0).Shape.GetRect().Size.X;
		area2d.GetChild<CollisionShape2D>(0).Scale = new Vector2(scale, scale);
